...
// Task 1
const tempsGreaterThanOrEqualTo25 = temperatures.filter((temp) => temp >= 25);

// Task 2
const tempsLessThan20 = temperatures.filter((temp) => temp < 20);

// To check our work
console.log(tempsGreaterThanOrEqualTo25);
...
// Task 4
const labelArray = temperatures.map((temp) => {
...
// Task 5
const highestTempOfTheMonth = temperatures.reduce((highest, temp) => temp > highest ? temp : highest, -Infinity);

// Task 6
const lowestTempOfTheMonth = temperatures.reduce((lowest, temp) => temp < lowest ? temp : lowest, Infinity);
